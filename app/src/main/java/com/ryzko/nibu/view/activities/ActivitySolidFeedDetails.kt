...
import kotlinx.android.synthetic.main.activity_solid_feed_details.*
...
class ActivitySolidFeedDetails : AppCompatActivity() {
    ...
    private val breastSideData = arrayListOf("left", "right", "both")

    private var dayString = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_solid_feed_details)
    ...
    private fun initViews() {
        ...
        text_breast_side.setOnClickListener { showBreastSideSelectionDialog() }
        setupDatesViews()
    ...
    private fun setupDatesViews() {
        ...
        for (v in dateViews) {
            ...
            v.setOnClickListener { k -> this.onDateViewClicked(k) }
        }

        saveButton.setOnClickListener { this.saveActivity() }
    }
    ...
    private fun saveActivity() {
        ...
        breastSide = text_breast_side.getText()
    ...
    private fun showBreastSideSelectionDialog() {
        ...
        builder.setPositiveButton(positiveText) { _, which ->
