 ...
 * [DashboardUserFragment.OnFragmentInteractionListener] interface
...
class DashboardUserFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String = "a", param2: String = "b"): DashboardUserFragment {
            val fragment = DashboardUserFragment()
            val args = Bundle()
