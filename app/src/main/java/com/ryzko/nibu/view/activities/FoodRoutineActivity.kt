...
class FoodRoutineActivity : AppCompatActivity() {
    ...
    var foodData:MutableList<FoodRoutineObjectData> = mutableListOf(FoodRoutineObjectData( start_time = "2012-07-07 19:30"),
            FoodRoutineObjectData( start_time = "2011-07-07 19:30"),
            FoodRoutineObjectData( start_time = "2012-07-07 19:30"),
            FoodRoutineObjectData( start_time = "2013-07-07 19:30"),
            FoodRoutineObjectData( start_time = "2012-07-07 19:30"),
            FoodRoutineObjectData( start_time = "2012-07-07 19:30"),
            FoodRoutineObjectData(start_time = "2014-06-07 19:30"))
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(foodData!=null){
            recyclerview_food_routines.adapter = FoodRoutinesListAdapter(foodData!!)
        }
