...
class FoodRoutineObjectData(id:Int=0, baby_id:Int=0, baby_sid:String="", start_time:String, end_time:String="2014-07-07 18:30", category:String = "food",
                            ...
                            val weight:Int=130) : BaseRoutineObjectData(id, baby_id, baby_sid, category, start_time, end_time){
